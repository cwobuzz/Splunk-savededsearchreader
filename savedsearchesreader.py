...
default_savedsearchesconf = os.path.abspath("dist/ESCU-Alerts/default/savedsearches.conf")
#local saved search file
local_savedsearches = os.path.abspath("dist/ESCU-Alerts/local/savedsearches.conf")
